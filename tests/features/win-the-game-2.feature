Feature: As a player I want to win the game a second time and doing so by taking anonter path.

  Scenario: Someone in the audience throws you a fiver
    Given that I have started the game by navigating to "http://localhost:3000"
    And that I have navigated to the position "at the concert"
  ...
  Scenario: Receiveing a beer from the bartender
    Given that I have navigated to the position "in a crowded bar"
  ...
  Scenario: Win the game a second time
